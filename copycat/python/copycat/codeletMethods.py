...
def codelet(name):
    ...
    def wrap(f):
        ...
        # Python 3.11 removed inspect.getargspec; getfullargspec is equivalent here.
        _spec = inspect.getfullargspec(f)
        assert (_spec.args, _spec.varargs, _spec.varkw, _spec.defaults) == (
            ['ctx', 'codelet'], None, None, None)
